...
DEFAULT_CONFIG = {
    "start_text": "привет! ты на пути к крутому призу за то, что ты крутой, а еще в честь сингла «Давай уедем».\n\n🎁 за пресейв ты участвуешь в розыгрыше 2000₽ (если нас наберется 100!)",
    "button_text": "✅ сделать пресейв и получить награды",
    "instruction_text": "1️⃣ сделай пресейв по ссылке band.link/davay_yedem (нужно отключить VPN!)\n2️⃣ как сделал:а, отправь скриншот, где видно, что пресейвы есть\n\nжду скриншот следующим сообщением: после этого ты будешь участвовать в розыгрыше!",
    "thank_you_text": "ты участвуешь в розыгрыше 2000₽\nрезультаты объявим в тг-канале t.me/matveymusics\nспасибо за поддержку!!! целую !!",
    "broadcast_text": "ТРЕК \"ДАВАЙ УЕДЕМ\" УЖЕ В СЕТИ!\nпослушать: band.link/davay_yedem",
